...
public partial class _admin_setup_general : System.Web.UI.Page
{
    ...
    protected void fill(string num, string sum, string search)
    {
        ...
        DataTable rs = Db.Rs("select Schedule_Role_ID, Schedule_Role_Code, Schedule_Role_Nama, Schedule_Role_Status, Schedule_Role_JamMasuk, Schedule_Role_JamKeluar from TBL_Schedule_Role where Schedule_Role_Status = 1 " + sql_where + " order By Schedule_Role_ID");
