...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Kehadiran</title>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div id="basicwizard" class=" pull-in">
                                        <ul>
                                            <li class="active">
                                                <asp:Literal ID="tab_fulltime" runat="server"></asp:Literal>
                                            </li>
                                            <li class="">
                                                <asp:Literal ID="tab_shift" runat="server"></asp:Literal>
                                            </li>
                                        </ul>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                                <tr>
                                                                    <td style="padding-right: 10px;">
                                                                        <asp:TextBox ID="search_text" class="form-control" runat="server" AutoPostBack="True" AutoComplete="off" placeholder="Search" OnTextChanged="btnSearch_Click" />
                                                                    </td>
                                                                    <td style="padding-right: 10px;">
