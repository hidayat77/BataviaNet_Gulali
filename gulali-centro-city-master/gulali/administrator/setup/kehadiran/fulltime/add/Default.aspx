    ...
    <form id="form" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Tambah Fulltime</h4>
                    </div>
                </div>
                <!-- end row -->
                                ...
                                <div class="col-lg-6">
                                    <div class="form-horizontal" role="form" runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtJamMasuk" class="form-control" runat="server" placeholder="Jam"></asp:TextBox>
                                            </div>

                                            <label class="col-md-2 control-label">Jam Keluar</label>
                                                <div class="col-md-2">
                                                    <asp:TextBox ID="txtJamKeluar" runat="server" class="form-control" placeholder="Jam"/>
                                                </div>
                                         </div>
                                        ...
                                        <div class="form-group" style="text-align: center">
                                            <asp:Button ID="PTKPSubmit" runat="server" Style="border: 1px solid #188ae2 !important; background-color: rgba(24, 138, 226, 0.15) !important; color: #188ae2 !important; border-radius: 2px; padding: 6px 14px;" Text ="Simpan" name="submit" AccessKey="s" OnClick="Submit1_Click" />
