                        ...
                        <div class="card-box p-b-0"  style="padding-top: 0px !important;">
                            ...
                            <!-- Nav tabs -->
                                ...
                                <div class="tab-content b-0 m-b-0">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="kontakdarurat">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="riwayatpendidikan">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="pengalamankerja">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tanggungan">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="infopembayaran">
                                    <div class="row"><br />
                                            <div class="col-lg-6">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
