...
public partial class _admin_keuangan_payroll : System.Web.UI.Page
{
    ...
    protected void fill(string from_date, string to_date, string month)
    {
        if (!string.IsNullOrEmpty(month))
        {
            ...
            */
            ...
            x.Append(" <table class=\"table table-striped table-bordered dataTable no-footer dtr-inline\" role=\"grid\" aria-describedby=\"datatable-buttons_info\" style=\"width:100%\"> <thead> <tr role=\"row\">"
    ...
    protected void BtnSubmit(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(rs.Rows[0]["Flag_DateCreate"].ToString()))
        {
            ...
            //else
            //{
            fill(From_Conv, To_Conv, ddl_bulan.SelectedValue);
    ...
    protected void BtnSubmit_Final(object sender, EventArgs e)
    {
        ...
        save_final(From_Conv, To_Conv);
    }


    protected void save_final(string from_date, string to_date)
    {
        DateTime From = Convert.ToDateTime(from_date);
        DateTime To = Convert.ToDateTime(to_date);
        DateTime From2 = Convert.ToDateTime(From);
