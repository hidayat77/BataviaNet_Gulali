                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="txt_pinjaman" runat="server" AutoPostBack="True" class="form-control" placeholder="Jumlah" OnTextChanged="txt_pinjaman_Load" onkeyup="javascript:this.value=MoneyFormat(this.value);" autocomplete="off"/>                                                            
                                                        </div>
                                                    </div>
                                                     <div class="form-group">
