<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_user_data_pribadi_surat_peringatan_detail" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Data Pribadi >> Surat Peringatan >> Detail</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Detail Surat Peringatan</h4>
                    </div>
                </div>
                <div class="row">
