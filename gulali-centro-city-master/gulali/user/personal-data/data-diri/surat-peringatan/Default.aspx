<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_user_data_pribadi_surat_peringatan" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Data Pribadi >> Surat Peringatan</title>
                                        ...
                                        <div style="padding: 10px !important; float: right;">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                        ...
                                                        <div>
                                                            <div style="float: left;">
                                                                <asp:DropDownList class="form-control" ID="ddl_search" runat="server">
                                                                    <asp:ListItem Value="Type of Warning Letter" Text="Jenis Peringatan" Selected="True" />
                                                    ...
                                                    <td style="text-align: center;">page <asp:TextBox ID="pagenum" runat="server" AutoPostBack="True" Width="25px" OnTextChanged="page_enter" />
                                                        of
