...
<html>
<head runat="server">
    <title>Gulali HRIS - Data Karyawan - Edit</title>
                            ...
                            <div class="col-sm-12">
                                <div class="form-horizontal" role="form" runat="server">
                                    ...
                                    <div class="card-box">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="checkbox">
                                                                <asp:CheckBox ID="checkbox_sim_a" runat="server" Text="SIM A" RepeatColumns="4" RepeatDirection="Vertikal"></asp:CheckBox>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="checkbox">
                                                                <asp:CheckBox ID="checkbox_sim_c" runat="server" Text="SIM C" RepeatColumns="4" RepeatDirection="Vertital"></asp:CheckBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30">Kontak Darurat</h4>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <table>
                                                                ...
                                                                <asp:Literal ID="table_kontak" runat="server" />
                                                            </table>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30">Riwayat Pendidikan Formal</h4>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30">Riwayat Pengalaman Kerja</h4>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30">Tanggungan</h4>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30">Info Pembayaran</h4>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="current_salary" class="form-control" runat="server" placeholder="Gaji"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Gaji PPH</label>
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="salary_pph" class="form-control" runat="server" placeholder="Gaji PPH"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Gaji BPJS</label>
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="salary_bpjs" class="form-control" runat="server" placeholder="Gaji BPJS"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="col-md-3">
                                                                <div class="radio">
                                                                    <asp:RadioButton ID="radio_npwp" runat="server" GroupName="npwp" Text="NPWP" OnCheckedChanged="radio_1" AutoPostBack="true"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <div class="radio">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">&nbsp;</label>
                                            <div class="col-md-8">
                                                <asp:Button ID="Submit" runat="server" Style="border: 1px solid #188ae2 !important; background-color: rgba(24, 138, 226, 0.15) !important; color: #188ae2 !important; border-radius: 2px; padding: 6px 14px;" Text="Simpan" name="submit"  AccessKey="s" OnClick="BtnSubmit"/>
                                                <asp:Button ID="Back" runat="server" Style="border: 1px solid #f9c851 !important; background-color: rgba(249, 200, 81, 0.15) !important; color: #f9c851 !important; border-radius: 2px; padding: 6px 14px;" Text="Batal" name="cancel" AccessKey="s" OnClick="BtnCancel"/>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                    </div>
