...
public partial class _data_karyawan_detail : System.Web.UI.Page
{
    ...
    protected void BtnSubmit(object sender, EventArgs e)
    {
        ...
        if (Join < Resign)
        {
            ...
            string update_info_payment = "update TBL_Employee_Payroll set Payroll_NPWP = '" + Cf.Int(sts_npwp) + "', Payroll_NPWP_Number = '" + Cf.StrSql(npwp_number.Text) + "',Payroll_OthersAllowance = '0',Payroll_Jamsostek = '0', Payroll_BPJS_Pribadi = '" + Cf.StrSql(ddl_personal_bpjs.SelectedValue) + "',Payroll_BPJS_Pribadi_Value = '" + Cf.StrSql(personal_bpjs_value.Text) + "',Payroll_BPJS_Ditanggung = '" + Cf.StrSql(ddl_bpjs_ditanggung.Text) + "',Payroll_SalaryPPH = '" + Cf.StrSql(salary_pph.Text) + "',Payroll_SalaryBPJS = '" + Cf.StrSql(salary_bpjs.Text) + "',Payroll_Group = '" + Cf.StrSql(ddl_payroll_group.SelectedValue) + "' where Employee_ID = '" + Cf.Int(id_get) + "'";
            ...
            string update_payment_history = "update TBL_HistorySalary set HistorySalary_Value = '" + Cf.StrSql(current_salary.Text) + "', HistorySalary_DateChanged = getdate() where Employee_ID = '" + encrypted + "'";
