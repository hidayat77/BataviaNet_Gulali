<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_surat_peringatan" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setting >> Data Karyawan >> History >> Surat Peringatan</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Surat Peringatan - <asp:Literal ID="nama_employee" runat="server"/></h4>
                    </div>
                </div>
                <div class="row">
                            <div class="col-sm-12">
