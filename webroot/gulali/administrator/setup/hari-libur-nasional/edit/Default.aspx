<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_hari_libur_nasional_edit" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Hari Libur >> Edit</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-horizontal" role="form" runat="server">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                    <asp:TextBox ID="holiday" runat="server" Enabled="false" disable CssClass="form-control" />
                                            </div>
                                        </div>
                                        <div class="form-group">
