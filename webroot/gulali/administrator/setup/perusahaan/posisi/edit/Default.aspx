<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_setup_posisi_edit" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Perusahaan >> Posisi >> Edit</title>
    ...
    <form id="form" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Edit Posisi</h4>
                    </div>
                </div>
                <!-- end row -->
