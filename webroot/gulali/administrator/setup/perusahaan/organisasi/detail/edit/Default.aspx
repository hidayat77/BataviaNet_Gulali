<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_setup_organisasi_detail_edit" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Organisasi >> Department >> Detail >> Edit</title>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-horizontal" role="form" runat="server">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Nama Divisi</label>
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtGroupname" class="form-control" runat="server" autocomplete="off"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
