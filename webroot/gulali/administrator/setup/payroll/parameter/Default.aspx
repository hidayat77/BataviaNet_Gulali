<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_setup_payroll_parameter" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Payroll >> Parameter</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Parameter</h4>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div id="basicwizard" class=" pull-in">
                            ...
                            <div class="card-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        THR :
                                    <asp:Literal ID="table_thr" runat="server" />
                                    </div>
                                </div>
                            </div>
                        </div>
