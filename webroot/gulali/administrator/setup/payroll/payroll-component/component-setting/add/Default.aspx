<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_component_setting_add" %>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-horizontal" role="form" runat="server">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtComponentcode" class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8" id="div_mode2" runat="server" visible="false">
                                                <asp:TextBox ID="txtComponentkind" class="form-control" runat="server" AutoComplete="off"></asp:TextBox>
                                            </div>
                                            <div class="col-md-8" id="div_mode3" runat="server" visible="false">
                                                <asp:TextBox ID="txtcomponent_deduction" class="form-control" runat="server" AutoComplete="off" Text="Potongan" ReadOnly="true" disabled=""></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Type</label>
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtComponenttype" class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
