<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_setup_payroll_ptkp_edit" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Payroll >> PTKP >> Edit</title>
    ...
    <form id="form" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Edit PTKP</h4>
                    </div>
                </div>
                <!-- end row -->
                                ...
                                <div class="col-sm-6">
                                    <div class="form-horizontal" role="form" runat="server">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtStatus" class="form-control" ReadOnly="true" disabled="" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtValue" class="form-control" runat="server" AutoComplete="off" onkeyup="javascript:this.value=MoneyFormat(this.value);"></asp:TextBox>
                                            </div>
                                        </div>
