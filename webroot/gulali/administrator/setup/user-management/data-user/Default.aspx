...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> User Management</title>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
                                                            <td style="padding-right: 10px;">
                                                                <asp:Literal ID="link_add" runat="server"></asp:Literal>
                                                            </td>
                                                            <td style="padding-right: 10px;">
                                                                <!-- search panel -->
                                                                <div style="text-align: right;">
                                                                    <asp:TextBox ID="search_text" class="form-control" runat="server" AutoPostBack="True" AutoComplete="off" placeholder="Nama Karyawan" OnTextChanged="btnSearch_Click" />
                                                                </div>
                                                            </td>
