<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_setup_usr_management" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> User Management >> User Group</title>
                                        ...
                                        <div style="padding: 10px !important; float: right;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 10px;">
                                                        <a class="btn btn-primary" href="data-user/">Data User</a>
                                                    </td>
                                                    <td style="padding-right: 10px;">
                                                        <!-- search panel -->
