<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_laporan_cuti" %>
    ...
    <form id="form" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive" style="padding-top: 0px !important; min-height:400px">
                                                        ...
                                                        <div>
                                                            <div style="float: left;">
                                                                <asp:DropDownList class="form-control" ID="ddl_employee" runat="server">
                                                                    <asp:ListItem Value="0" Text="-- Semua Karyawan --" />
                                                                </asp:DropDownList>
                                                            </div>
