        ...
        if (rs.Rows.Count > 0)
        {
            ...
            if (dari > 0)
            {
                for (int i = dari - 1; i < sampai; i++)
                {
                    ...
                    string tgl_mulai = rs.Rows[i]["Pinjaman_DateFrom"].ToString();
                    string tgl_selesai = rs.Rows[i]["Pinjaman_DateTo"].ToString();
                    ...
                    double pokok = 0;
                    double pinjaman_angsuran = 0;
                    pokok = Convert.ToDouble(rs.Rows[i]["Pinjaman_Pokok"]);
                    pinjaman_angsuran = Convert.ToDouble(rs.Rows[i]["Pinjaman_Angsuran_Perbulan"]);
                    ...
                    x.Append("<tr>"
                                ...
                                + "<td valign=\"top\">" + tgl_1.ToString("dd MMMM yyyy") + "</td>"
                                + "<td valign=\"top\">" + tgl_2.ToString("dd MMMM yyyy") + "</td>"
                                + "<td valign=\"top\">" + rs.Rows[i]["Pinjaman_Lama_Bulan"].ToString() + " Bulan"+"</td>"
                                + "<td valign=\"top\">" + Cf.money(pokok, true) + "</td>"
                                + "<td valign=\"top\">" + Cf.money(pinjaman_angsuran, true) + "</td>"
