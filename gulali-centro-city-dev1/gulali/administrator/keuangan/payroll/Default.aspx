...
<head id="head" runat="server">
    <title>Gulali HRIS - Keuangan >> Payroll</title>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
                                                            <td style="padding-right: 10px;">
                                                                <a class="btn btn-primary" href="generate/">Tambah</a>
                                                            </td>
                                                            <td style="padding-right: 10px;">
                                                                <!-- search panel -->
                                                                <div style="text-align: right;">
                                                                    <asp:DropDownList class="form-control" ID="ddl_search" runat="server">
                                                                        <asp:ListItem Value="search_month" Text="Bulan" Selected="True" />
                                                                        <asp:ListItem Value="search_year" Text="Tahun" />
                                                                    </asp:DropDownList>
