...
public partial class _admin_keuangan_payroll : System.Web.UI.Page
{
    ...
    protected double GajiTunjanganFunction(int month_conv, string To_Conv_Year, string encrypted, double basicSalary, double tunjangan, double value_BPJSPribadi)
    {
        ...
        if (month_conv > 1)
        {
            ...
            if (akumulasi.Rows.Count > 0)
            {
                ...
                else { gajitunjangan = (basicSalary + tunjangan) * (12 - ((12 - month_conv) + (month_conv - 1))) ; }
            }
           
        }
        else
        {
            gajitunjangan = (basicSalary + tunjangan) * (12 - (12 - month_conv)) ;
        }
        return gajitunjangan;
    }
    private static Tuple.Double7<double, double, double, double, double, double, double>
        PARAMETER_PAYROLL(string Status_bpjsPribadi, string IDEmployee, double basicsalaryBPJS, double basicsalaryBPJSTK)
    {
        ...
        var tuple = new Tuple.Double7<double, double, double, double, double, double, double>(jkk, jkm, jht, bpjsKesehatan, bpjsPegawai, bpjsFix, val_biaya_jabatan);
        return tuple;
    ...
    protected double AllowanceIrreguler(string IDEmployee)
    {
       ...
       private static Tuple.Double2<double, double>
     Cek_PreviousIrreguler(string encrypted, string original)
    {
        ...
        var tuple = new Tuple.Double2<double, double>(previous_IrregularIncome, previous_UnpaidLeave);
        return tuple;
    }
    private static Tuple.Double2_String2<double, double, string, string>
         THRFunction(string joinDate, string religion, double basicsalary, double tunjangan, int month_conv, string To_Conv_Year)
    {
        ...
        var tuple = new Tuple.Double2_String2<double, double, string, string>(THR, THRprorate, year_employment, month_employment);
        return tuple;
    }

    private static Tuple.Double2_String2<double, double, string, string> THRFunctionAngsur(string joinDate, string religion, double basicsalary, double tunjangan, int month_conv, string To_Conv_Year)
    {
        string year_employment = "0", month_employment = "0", week_employment = "0", day_employment = "0";
        if (!string.IsNullOrEmpty(joinDate))
        {
