...
+ App.Normal(Convert.ToDecimal(tunjangan)) + "</td></tr>"
    ...
    private static Tuple.String1_Decimal2<string, decimal, decimal> modal_dialog_total_irregular(string id_emp, string month, string encrypted, string original, string strMonthPast, decimal IrregularIncome, decimal THR, decimal overtime, decimal Bonus, decimal incentive, decimal value_bpjsPribadi)
    {
        string z = "";
...
+ App.Normal(Convert.ToDecimal(IrregularIncome)) + "</td></tr>"
        ...
        var tuple = new Tuple.String1_Decimal2<string, decimal, decimal>(z, tunjanganIrregular, previous_IrregularIncome);
        return tuple;
