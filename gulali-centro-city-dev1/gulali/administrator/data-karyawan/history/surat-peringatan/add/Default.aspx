<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_surat_peringatan_add" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setting >> Data Karyawan >> History >> Surat Peringatan >> Tambah</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Tambah Surat Peringatan - <asp:Literal ID="nama_employee" runat="server"/></h4>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-horizontal" role="form" runat="server">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <asp:DropDownList ID="ddl_type_warning" class="form-control" runat="server">
