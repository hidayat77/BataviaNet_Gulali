        ...
        if (rs.Rows.Count > 0)
        {
            ...
            if (dari > 0)
            {
                for (int i = dari - 1; i < sampai; i++)
                {
                    ...
                    if (rs.Rows[i]["Lembur_Status"].ToString() == "4") { style = "style=\"color:#FF0000;font-weight:bold;\""; }
