<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_setup_payroll_parameter_edit" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Payroll >> Parameter >> Edit</title>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-horizontal" role="form" runat="server">
                                        ...
                                        <div class="form-group" id="tr_choose" runat="server" visible="false">
