<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_admin_setup_usr_management_detail_edit" %>
...
<html>
<head>
    <title>Gulali HRIS - Setup >> User Management >> Edit</title>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <asp:DropDownList ID="ddl_Employee_Name" class="form-control" runat="server" disabled value="Disabled value">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" id="div_conf_password" runat="server" visible="false">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <asp:CheckBox ID="cbspecial" runat="server" OnCheckedChanged="cb_CheckedChanged" AutoPostBack="true" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
