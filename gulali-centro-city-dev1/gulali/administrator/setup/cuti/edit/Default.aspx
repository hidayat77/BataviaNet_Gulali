<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_master_type_cuti_edit" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Setup >> Master Tipe Cuti >> Edit</title>
    ...
    <form id="form" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Tipe Cuti</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
