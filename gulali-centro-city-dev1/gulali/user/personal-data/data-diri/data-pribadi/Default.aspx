<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_user_data_pribadi" %>
...
<html>
<head runat="server">
    <title>Gulali HRIS - User - Data Pribadi</title>
    ...
    <form id="form" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Data Pribadi</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div id="basicwizard" class=" pull-in">
                                ...
                                <div class="form-horizontal" role="form" runat="server">
                                    <div class="card-box">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="tanggal_lahir" runat="server" class="form-control" placeholder="Tanggal Lahir" ReadOnly="true" disabled="" />
                                                            <asp:TextBox ID="old" runat="server" class="form-control" ReadOnly="true" disabled="" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="checkbox">
                                                                <asp:CheckBox ReadOnly="true" disabled="" ID="checkbox_sim_a" runat="server" />
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="checkbox">
                                                                <asp:CheckBox ReadOnly="true" disabled="" ID="checkbox_sim_c" runat="server" />
                                                                <label for="control-label">
                                                                    SIM C
                                                                </label>
                                                            </div>
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30" id="h4_kontak_darurat" runat="server">Kontak Darurat</h4>
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30" id="h4_riwayat_pendidikan_formal" runat="server">Riwayat Pendidikan Formal</h4>
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30" id="h4_riwayat_pengalaman_kerja" runat="server">Riwayat Pengalaman Kerja</h4>
                                        ...
                                        <h4 class="header-title m-t-30 m-b-30" id="h4_tanggungan" runat="server">Tanggungan</h4>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:Label ID="Label2" runat="server" Text="NPWP"></asp:Label>
                                                            <asp:RadioButton ID="radio_npwp" runat="server" GroupName="npwp" />
                                                            <asp:Label ID="Label3" runat="server" Text="NonNPWP"></asp:Label>
                                                            <asp:RadioButton ID="radio_non_npwp" runat="server" GroupName="npwp" />
                                                        </div>
                                                    </div>
