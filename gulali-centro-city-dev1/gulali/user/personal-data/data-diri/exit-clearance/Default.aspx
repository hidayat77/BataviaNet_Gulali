<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_user_exit_clearance" %>
...
<html>
<head runat="server">
    <title>Gulali HRIS - User - Exit Clearance</title>
                        ...
                        <div class="card-box p-b-0" style="padding-top: 0px !important;">
                            <div id="basicwizard" class=" pull-in">
                                ...
                                <div class="form-horizontal" role="form" runat="server">
                                    <div class="card-box">
                                        <h4 class="header-title m-t-0 m-b-30">Exit Clearance</h4>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-horizontal" role="form" runat="server">
                                                    test
