                                ...
                                <asp:UpdatePanel ID="update" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div class="form-horizontal" role="form" runat="server">
                                            ...
                                            <div class="form-group" id="div_spvremarks" runat="server" visible="false">
                                                <label class="col-md-3 control-label">
                                                    Catatan<br />
                                                    (Supervisor)</label>
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="spvremarks" TextMode="MultiLine" runat="server" CssClass="form-control" autocomplete="off" />
                                                    <asp:Literal ID="spvremarksby" runat="server" />
                                                </div>
                                            </div>
                                            <div class="form-group" style="text-align: center !important; width: 100%;">
                                                ...
                                                <div class="col-md-8">
                                                    <div id="div_approve" visible="false" runat="server" style="float: left">
                                                        <asp:Button ID="Approve" runat="server" Style="border: 1px solid #10c469 !important; background-color: rgba(249, 200, 81, 0.15) !important; color: #10c469 !important; border-radius: 2px; padding: 6px 14px;" Text="Approve" name="Approve" OnClick="BtnApprove" AccessKey="s" />
                                                    </div>
                                    ...
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="Approve" />
