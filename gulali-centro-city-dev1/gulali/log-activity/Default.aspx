<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_log_aktifitas" %>
...
<head id="head" runat="server">
    <title>Gulali HRIS - Log Aktifitas</title>
                                            ...
                                            <div id="datatable-buttons_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                <div style="padding: 10px !important; float: right;">
                                                    ...
                                                    <asp:Literal ID="count_page" runat="server" />
                                                        ...
                                                        <asp:Literal ID="pagesum" Text="25" runat="server"></asp:Literal>
                                                                per page
                                                            </td>
                                                        </tr>
                                                    </table>
